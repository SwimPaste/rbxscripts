local Bypasses = {
    ...
    ["childporn"] = "chieldpo{{aieixzvzx:rn}}",
    ...
    ["ебали"] = "е{{aieixzvzx:бали}}",
    ["лошара"] = "ло{{aieixzvzx:шара}}",
    ["лох"] = "л{{aieixzvzx:ох}}",
    ["сука"] = "сук{{aieixzvzx:а}}",
    ["суку"] = "су{{aieixzvzx:ку}}",
    ["нахуе"] = "Hax{{aieixzvzx:уе}}",
    ["хуй"] = "х{{aieixzvzx:уй}}",
    ["хохол"] = "xoxo{{aieixzvzx:л}}",
    ["даун"] = "да{{aieixzvzx:ун}}",
    ["ебал"] = "е{{aieixzvzx:бал}}",
    ["ебать"] = "е{{aieixzvzx:бать}}",
    ["ебатня"] = "е{{aieixzvzx:батня}}",
    ["ебанное"] = "е{{aieixzvzx:банное}}",
    ["ебаное"] = "е{{aieixzvzx:баное}}",
    ["долбаеб"] = "dolbae{{aieixzvzx:b}}",
    ["долбаёб"] = "dolbae{{aieixzvzx:b}}",
    ["ебать"] = "е{{aieixzvzx:бать}}",
